...
export function LoginForm() {
  ...
  return (
    <div className="grid min-h-screen bg-background lg:grid-cols-[1.08fr_0.92fr]">
      <section className="hidden border-r border-brand-300/45 bg-[linear-gradient(180deg,rgba(255,255,255,0.74),rgba(247,243,238,0.9))] p-12 lg:flex lg:flex-col lg:justify-between">
        <div>
          <LogoMark />
        </div>
        <div className="max-w-xl">
          <p className="inline-flex rounded-full border border-brand-300/55 bg-white/75 px-3 py-1 text-xs font-medium uppercase tracking-[0.08em] text-brand-600">
            CRM MBW
          </p>
          <h1 className="mt-5 text-5xl font-semibold leading-[1.05] tracking-[-0.04em] text-brand-950 xl:text-6xl">
            Gestao comercial sofisticada, clara e focada no essencial.
          </h1>
          <p className="mt-6 max-w-lg text-base leading-8 text-brand-600">
      ...
      <section className="flex items-center justify-center px-5 py-10 sm:px-8 lg:px-12">
        <Card className="w-full max-w-md border-brand-300/50">
          <CardHeader className="space-y-3">
            <p className="text-sm font-medium text-brand-600">Acesso seguro</p>
            <CardTitle className="text-3xl font-semibold tracking-[-0.03em]">Entrar</CardTitle>
            <CardDescription>
